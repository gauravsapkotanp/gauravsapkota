        ...
        <>
            <AdminLayout>
                <div className="pt-12 lg:pt-0 px-4 pb-36 bg-gradient-to-r from-orange-400 to-orange-500">
                    <h1 className="text-lg font-thin text-white pt-12 lg:pl-4 uppercase">
                        Edit Blog
                    </h1>
                </div>
                <div className="p-4 mx-3 lg:mx-5 overflow-x-auto overflow-y-hidden bg-white rounded-xl shadow-md -mt-28">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label
                                htmlFor="photopath"
                                className="  text-white hover:bg-transparent border-2 bg-orange-500   hover:border-primary duration-1000 hover:text-primary py-2 px-4  rounded-lg cursor-pointer"
                            >
                                Choose New Image
                            </label>
                            <input
                        ...
                        {selectedImage ? (
                            ...
                            <img
                                src={`/img/blogs/${values.photopath}`}
                                alt="Current"
                                className="mb-4 rounded-xl h-full"
                                style={{ maxWidth: "400px" }}
                            />
