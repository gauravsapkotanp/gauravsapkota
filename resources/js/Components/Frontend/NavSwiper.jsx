...
const NavSwiper = () => {
    ...
    return (
        <div>
                                ...
                                <div className="relative z-40">
                                    ...
                                    <div className="mt-2 max-w-[48rem] line-clamp-2">
                                        <p className="text-gray-500 tracking-wider">
                                            ...
                                            Mollitia fugiat consequatur voluptas
                                            incidunt quam! Omnis commodi eius
                                            nulla tempore sed temporibus iste,
                                            doloremque non, laudantium
            ...
            <div className="bg-[#181818] py-2 px-16"></div>
        </div>
    );
};
